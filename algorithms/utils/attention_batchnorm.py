...
class resnet(nn.Module):
    def __init__(self, dropout_prob):
        ...
        self.conv_half3 = nn.Conv2d(in_channels=64, out_channels=32, kernel_size=4, stride=2, padding=1)
        ...
        self.average2 = nn.AvgPool2d(kernel_size=2, stride=2)  
        self.average3 = nn.AvgPool2d(kernel_size=3, stride=2)  
    ...
    def forward(self, x):
        ...
        # print("Before~~~~~Shape of residual_x:", residual_x.shape)
...
class Attention_model(nn.Module):
    ...
    def forward(self, x):
        ...
        # print("shape of x:", x.shape) # shape of x: torch.Size([225, 32, 64]
