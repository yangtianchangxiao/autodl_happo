...
# from light_mappo.envs.mpe.MPE_env import MPEEnv
from light_mappo.envs.env_wrappers import SubprocVecEnv, DummyVecEnv
...
def main(args):
    ...
    if all_args.share_policy:
        from light_mappo.runner.shared.mpe_runner import MPERunner as Runner
    else:
