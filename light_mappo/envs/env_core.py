...
class EnvCore(object):
    ...
    def step(self, actions):
        ...
        """
        sub_agent_obs, sub_agent_reward, sub_agent_done, sub_agent_info, sub_agent_joint_map = self.env.step(actions)
        # sub_agent_obs = []
        # sub_agent_reward = []
        # sub_agent_done = []
        # sub_agent_info = []
        ...
        return [sub_agent_obs, sub_agent_reward, sub_agent_done, sub_agent_info, sub_agent_joint_map]
