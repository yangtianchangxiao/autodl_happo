...
class ACTLayer(nn.Module):
    ...
    def __init__(self, action_space, inputs_dim, use_orthogonal, gain):
        ...
        if action_space.__class__.__name__ == "Discrete":
            ...
            # Categorical is a single layer mlp
    ...
    def forward(self, x, available_actions=None, deterministic=False):
        ...
        if self.mixed_action:
            ...
            # print("determinsitic", deterministic)
            # action_logits is an object while action_logits_value is the value of log probability of all actions.
            action_logits, action_logits_value = self.action_out(x, available_actions)
            # print("action_logit is", action_logits)
            # print("determinisitics",deterministic)
            actions = action_logits.mode() if deterministic else action_logits.sample()
            # print("action_logits_value are", action_logits_value)
            action_log_probs = action_logits.log_probs(actions)
            # print("action_log_probs",action_log_probs)

        return actions, action_log_probs, action_logits_value
    ...
    def evaluate_actions(self, x, action, available_actions=None, active_masks=None):
        ...
        if self.mixed_action:
            ...
            action_logits, action_logits_value = self.action_out(x, available_actions)
            # print("action_logit",action_logits)
