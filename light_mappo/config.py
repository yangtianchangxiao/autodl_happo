...
def get_config():
    ...
    parser.add_argument("--num_env_steps", type=int, default=1e8,
    ...
    parser.add_argument("--recurrent_N", type=int, default=4, help="The number of recurrent layers.")
    ...
    # ICM parameters
    parser.add_argument("--enable_ICM", action='store_true', default=False, help="Enable ICM")
    # imc_lr
    parser.add_argument("--icm_lr", type=float, default=5e-4)
    # Scale the intrinsic reward
    parser.add_argument("--reward_scale", type=float, default=1)
    # Balance intrinsic loss and policy loss
    parser.add_argument("--policy_weight", type=float, default=1)
    # Balance the forward loos and inverse loose, which are two parts of intrinsic loss
    ...
    parser.add_argument("--clip_parameter_range", type=list,default=[0.1, 0.25], help="The minimum and maximum clip parameter")
